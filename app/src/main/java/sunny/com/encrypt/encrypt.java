...
import sunny.com.photo_data.Encryptdata;
...
public class encrypt {
    ...
    public void encryptdata(String message,String ke) throws Exception
    {
        ...
        String EncKeKi=encryptAES(ki.toString(), ke);       //生成ke加密的ki
        encryptdata.getsup(ensup);
        encryptdata.getEnckeki(EncKeKi);
...
//    {
//        String message="sup";
//        String ke="get from the phone";
//        String enckeki=encrypmessage(message, ke);
//    }
}